...
function switcherClick() {
    ...
    let primaryColor1Var = primaryDefaultColor1Btn.addEventListener('click', () => {
        ...
        localStorage.setItem("primaryRGB", "49, 60, 113");
        html.style.setProperty('--primary-rgb', `49, 60, 113`);
        updateColors();
    })
    ...
    let primaryColor3Var = primaryDefaultColor3Btn.addEventListener('click', () => {
        ...
        localStorage.setItem("primaryRGB", "239, 127, 26");
        html.style.setProperty('--primary-rgb', `239, 127, 26`);
        updateColors();
    })
